<x-app-layout>
    ...
    <section class='mx-auto section-content'>
        ...
        <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-4">
            <div class='text-center border-dark pt-4'>
            ...
            <article class='mt-4'>
                <h3 class='fw-bold w-75 mx-auto mb-2 text-center'>Доход системы за все время</h3>
            ...
            <article class="mt-4 w-75 mx-auto d-flex flex-column align-items-center article-commission">
                <h3 class='fw-bold pb-4'>Комиссия системы (%)</h3>
