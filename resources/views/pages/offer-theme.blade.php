<x-app-layout>
    ...
    <section class='section-content mx-auto'>
        <x-slot name="header">
        ...
        <section class="p-6 bg-white border-b border-gray-200 text-center fs-4 mt-4">
            ...
            <article class='mb-4'>
                ...
                <form action='/' method='post' id='form-add-theme' class='text-center mt-4 mx-auto w-80'>
                    @csrf
                    <label for="offer-new__name" class='fw-bolder w-80 text-center ps-2'>Название:</label><br>
                    <input type="text" name="name" class='w-80 mb-2 border' id="offer-new__name" required><br>
            ...
            <article>
                ...
                <table class='table mx-auto w-80' id='table-themes'>
